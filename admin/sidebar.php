...
<ul class="menu side-bar navbar-nav px-0">
    ...
    <div class="d-flex flex-column row-gap-1 pt-3 px-2">
        ...
        <hr class="text-dark m-0">
        <li class="nav-item">
            <a href="user-information" class="nav-link px-2">
                <span class="icon-span"><i class="fa-solid fa-users m-auto"></i></span>
                <span class="text-span">User Information</span>
                <span class="tooltips text-dark text-nowrap p-1">User Information</span>
            </a>
        </li>
        <hr class="text-dark m-0">
        <li class="nav-item">
        ...
        <hr class="text-dark m-0">
        <li class="nav-item">
            <a href="feedback-information" class="nav-link px-2">
                <span class="icon-span"><i class="fa-solid fa-user m-auto"></i></span>
                <span class="text-span">Feedback Information</span>
                <span class="tooltips text-dark text-nowrap p-1">Feedback Information</span>
            </a>
        </li>
        <hr class="text-dark m-0">
        <li class="nav-item">
